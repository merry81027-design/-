...
# 1. 網頁基本設定
# ==========================================
st.set_page_config(page_title="高中生落點查詢系統", page_icon="🎓", layout="centered")
st.title("🎓 112-114年 個申最低錄取分數查詢系統")
st.markdown("💡 **搜尋技巧**：請打校系全名，中間需空格，例如輸入 `國立臺灣大學 資訊工程學系`。資料與雲端試算表即時同步！")
st.divider()
